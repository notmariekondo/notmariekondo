...
- [JohnHammond/msdt-follina](https://github.com/JohnHammond/msdt-follina) - Codebase to generate an msdt-follina payload (today)
- [sigoden/duf](https://github.com/sigoden/duf) - Duf is a simple file server. Support static serve, search, upload, webdav... (1 day ago)
